                  ...
                  <div className="mt-4 flex justify-between items-center bg-white p-3 rounded-md">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <button
                          ...
                          className="w-24 p-2 border rounded-md text-center text-lg font-bold flex items-center justify-between hover:bg-gray-50 disabled:bg-gray-100 disabled:cursor-not-allowed"
