        ...
        <div className="flex-grow overflow-auto relative">
             <div className="relative w-full h-full min-h-[500px]">
              {tablesInSelectedArea.map(table => {
                  ...
                  let statusText = null;
                    switch (status) {
                      case 'pending': bgColor = 'bg-yellow-500'; statusText = t('pending'); break;
                      case 'preparing': bgColor = 'bg-blue-500'; statusText = t('preparing'); break;
                      case 'ready': bgColor = 'bg-purple-500'; statusText = t('readyToPay'); break;
                      case 'held': bgColor = 'bg-orange-500'; statusText = t('holdOrder'); break;
                    }
                    const handleClick = () => {
